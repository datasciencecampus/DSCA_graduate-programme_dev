...
| 2.2.1         | Effort to deconstruct binaries or point to limitations in data.             |
| 2.2.2         | Self disclosure evident.                                                    |
| 2.2.3         | Consideration for those at risk of marginalisation, treatment of outliers, minority groups, power dynamics in the design process.                                        |
| 2.2.4         | Intersectional context of visualisation acknowledged.                       |
| 2.2.5         | Adapts metadata to give an adequate treatment to acknowledging labour at all stages in the visualisation process.                                                          |
| 2.2.6         | An attempt to consider the data from multiple perspectives, embracing plurality.                                                                                    |

| Level 3       | Significant adaptation to visual design & principles.                       |
|---------------|:----------------------------------------------------------------------------|
| 3.1           | Exhibits creative consideration in adapting the GSS / ONS style visualisation, implementing design changes capable of invoking affect, empathy, embodiment of the data subject.                                                                             |
