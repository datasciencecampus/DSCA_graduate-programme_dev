...
In conclusion, we've taken a bit of a worldwind tour through the utility and some of the pitfalls of some common statistics. Hopefully you've managed to extract some ne knowledge from somewhere in this course and if not, have had the opportunity to recap and consolidate your understanding. we covered:
