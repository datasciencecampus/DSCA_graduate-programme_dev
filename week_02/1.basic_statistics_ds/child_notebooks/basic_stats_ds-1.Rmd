...
This bit loses some people, so let's lean in to it. Forget about the minus 1 for now. We're dividing by the number of observations in the column. That is going to correct our statistic for the number of observations. Therefore really large datasets can have a comparable value to smaller ones.
