...
Sometimes these are referred to as box and whiskers plot. they're useful to quickly assess the distribution of a single variable. Note the labelling on the following diagram.
